...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0002_student_education_start_date_teacher_position_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='users.student')),
                ('student_group', models.ManyToManyField(to='users.studentgroup')),
                ('teacher', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='users.teacher')),
            ],
            options={
                'abstract': False,
            },
